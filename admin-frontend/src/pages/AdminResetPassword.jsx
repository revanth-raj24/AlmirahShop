...
export default function AdminResetPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setTimeout(() => {
        navigate('/admin/login?message=' + encodeURIComponent('Password reset successful. Please login with your new password.'));
      }, 3000);
    } catch (err) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="bg-white border border-neutral-300 rounded-lg p-8 shadow-sm">
          <div className="mb-6">
            <Link to="/admin/login" className="inline-flex items-center text-sm text-neutral-600 hover:text-neutral-900 mb-4">
