...
export default function SellerOTPVerification() {
  ...
  const handleVerify = async (e) => {
    ...
    try {
      ...
      setMessage('Email verified successfully! Your seller account is now active. Please wait for admin approval before you can start selling.');
      setTimeout(() => {
        navigate('/seller/login?message=Email%20verified%20successfully!%20Please%20wait%20for%20admin%20approval%20to%20access%20seller%20dashboard.');
      }, 3000);
    } catch (err) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <h1 className="font-serif text-4xl text-neutral-900 mb-2 text-center">Verify Seller Account</h1>
